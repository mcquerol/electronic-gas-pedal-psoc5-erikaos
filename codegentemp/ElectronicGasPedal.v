// ======================================================================
// ElectronicGasPedal.v generated from TopDesign.cysch
// 07/24/2023 at 15:40
...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_1863),
        .rx_data(Net_1864),
        .rx_interrupt(Net_1865),
        .tx(Net_1857),
        .tx_clk(Net_1866),
        .tx_data(Net_1867),
        .tx_en(Net_1868),
        .tx_interrupt(Net_1869));
    ...
    SPI_Master_v2_50_6 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_2012),
        .sclk(wTFT_SCL),
        .sdat(Net_2013),
        .ss(Net_2014),
        .tx_interrupt(Net_2015));
